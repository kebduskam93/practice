...
# Function - reusable block of code! - Malum bir mantiqni ishga tushurib beradigan code bloq
# Instead of block {} in JAVA, Python uses indentation!


# DEFINE - parametr (build)
# pass   # pythonda buni qoyish kerak hech narsa mavjud emas hechnarsa qilma degan manoni bildiradi 
def greet(a):
